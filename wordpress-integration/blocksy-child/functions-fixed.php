<?php
/**
 * Temoakte Fixed Theme Functions
 * Uses app.css for styling, simplified JS for functionality
 */

/**
 * Enqueue assets with fixed JavaScript
 */
function temoakte_enqueue_fixed_assets() {
    ...
    // Use simplified JS instead of problematic app.js
    wp_enqueue_script('temoakte-simple-js',
        get_stylesheet_directory_uri() . '/assets/js/temoakte-simple.js',
        array(),
        filemtime(get_stylesheet_directory() . '/assets/js/temoakte-simple.js'),
        true
    );
    
    // AJAX localization
    wp_localize_script('temoakte-simple-js', 'temoakte_ajax', array(
        'ajax_url' => admin_url('admin-ajax.php'),
        'nonce' => wp_create_nonce('temoakte_nonce')
    ));
}
add_action('wp_enqueue_scripts', 'temoakte_enqueue_fixed_assets');

/**
 * Add dark mode detection script to head
 */
function temoakte_dark_mode_script() {
    ?>
    <script>
...
add_action('wp_head', 'temoakte_dark_mode_script', 1);

/**
 * Theme setup
 */
function temoakte_fixed_theme_setup() {
...
add_action('after_setup_theme', 'temoakte_fixed_theme_setup');

/**
 * Register widget areas
 */
function temoakte_fixed_widgets_init() {
...
add_action('widgets_init', 'temoakte_fixed_widgets_init');
